...
class FruitFreshMatter(ParameterizedProcess):
    ...
    nmol_solutes = xs.foreign(fruit_quality.FruitQuality, 'nmol_solutes')
    mass_suc = xs.foreign(fruit_quality.FruitQuality, 'mass_suc')
    mass_glc = xs.foreign(fruit_quality.FruitQuality, 'mass_glc')
    mass_frc = xs.foreign(fruit_quality.FruitQuality, 'mass_frc')
    mass_sta = xs.foreign(fruit_quality.FruitQuality, 'mass_sta')
    mass_mal = xs.foreign(fruit_quality.FruitQuality, 'mass_mal')
    mass_cit = xs.foreign(fruit_quality.FruitQuality, 'mass_cit')
